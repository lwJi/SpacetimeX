...
extern "C" void TestSTXUtils_CalcSTXUtils(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_TestSTXUtils_CalcSTXUtils;
  DECLARE_CCTK_PARAMETERS;
  ...
  STXUtils::calc_derivs2<0, 0, 0>(t5_chi, t5_dchi, t5_ddchi, layout5, grid,
    ...
    grid.loop_int_device<0, 0, 0, vsize>(
        grid.nghostzones, [=] ARITH_DEVICE(const PointDesc &p) ARITH_INLINE {
          ...
          gf_chi_diss.store(mask, index2,
                            STXUtils::calc_diss<2>(gf2_chi, mask, p.I, dx));
          gf_chi_upwind.store(
              mask, index2,
              STXUtils::calc_deriv_upwind<2>(gf2_chi, mask, p.I, dx,
                                           gf_beta(mask, index2)));
        });
    break;
  }
  case 4: {
    grid.loop_int_device<0, 0, 0, vsize>(
        grid.nghostzones, [=] ARITH_DEVICE(const PointDesc &p) ARITH_INLINE {
          ...
          gf_ddchi.store(mask, index2, t5_ddchi(mask, index5));
          gf_chi_diss.store(mask, index2,
                            STXUtils::calc_diss<4>(gf2_chi, mask, p.I, dx));
          gf_chi_upwind.store(
              mask, index2,
              STXUtils::calc_deriv_upwind<4>(gf2_chi, mask, p.I, dx,
                                           gf_beta(mask, index2)));
        });
    break;
  }
  case 6: {
    grid.loop_int_device<0, 0, 0, vsize>(
        grid.nghostzones, [=] ARITH_DEVICE(const PointDesc &p) ARITH_INLINE {
          ...
          gf_ddchi.store(mask, index2, t5_ddchi(mask, index5));
          gf_chi_diss.store(mask, index2,
                            STXUtils::calc_diss<6>(gf2_chi, mask, p.I, dx));
          gf_chi_upwind.store(
              mask, index2,
              STXUtils::calc_deriv_upwind<6>(gf2_chi, mask, p.I, dx,
                                           gf_beta(mask, index2)));
        });
    break;
  }
  case 8: {
    grid.loop_int_device<0, 0, 0, vsize>(
        grid.nghostzones, [=] ARITH_DEVICE(const PointDesc &p) ARITH_INLINE {
          ...
          gf_ddchi.store(mask, index2, t5_ddchi(mask, index5));
          gf_chi_diss.store(mask, index2,
                            STXUtils::calc_diss<8>(gf2_chi, mask, p.I, dx));
          gf_chi_upwind.store(
              mask, index2,
              STXUtils::calc_deriv_upwind<8>(gf2_chi, mask, p.I, dx,
                                           gf_beta(mask, index2)));
        });
    break;
  }
