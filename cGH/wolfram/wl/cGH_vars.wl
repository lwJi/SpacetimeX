...
cGHEvolVarlist = DefTensors[
  ...
  {hH[-i], PrintAs -> "\!\(\*OverscriptBox[\(H\), \(^\)]\)"}
];

cGHdnEvolVarlist = DefTensors[
  {dnhg[-i, -j],       Symmetric[{-i, -j}], PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*OverscriptBox[\(g\), \(^\)]\)"},
  {dnhPi[-i, -j],      Symmetric[{-i, -j}], PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*OverscriptBox[\(\[CapitalPi]\), \(^\)]\)"},
  {dnhPhi[-k, -i, -j], Symmetric[{-i, -j}], PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*OverscriptBox[\(\[CapitalPhi]\), \(^\)]\)"},
  {dnhgn[i],       PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*SubscriptBox[OverscriptBox[\(g\), \(^\)], \(n\)]\)"},
  {dnhPin[i],      PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*SubscriptBox[OverscriptBox[\(\[CapitalPi]\), \(^\)], \(n\)]\)"},
  {dnhPhin[-k, i], PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*SubscriptBox[OverscriptBox[\(\[CapitalPhi]\), \(^\)], \(n\)]\)"},
  {dnhgnn[],     PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*SubscriptBox[OverscriptBox[\(g\), \(^\)], \(nn\)]\)"},
  {dnhPinn[],    PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*SubscriptBox[OverscriptBox[\(\[CapitalPi]\), \(^\)], \(nn\)]\)"},
  {dnhPhinn[-k], PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*SubscriptBox[OverscriptBox[\(\[CapitalPhi]\), \(^\)], \(nn\)]\)"},
  {dnW[],      PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)W"},
  {dnWPi[],    PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*StyleBox[\"\[CapitalPi]\",\nFontSlant->\"Italic\"]\)"},
  {dnWPhi[-k], PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*StyleBox[\"\[CapitalPhi]\",\nFontSlant->\"Italic\"]\)"},
  {dnhHn[],  PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*SubscriptBox[OverscriptBox[\(H\), \(^\)], \(n\)]\)"},
  {dnhH[-i], PrintAs -> "\!\(\*SubscriptBox[\(\[PartialD]\), \(n\)]\)\!\(\*OverscriptBox[\(H\), \(^\)]\)"}
];
